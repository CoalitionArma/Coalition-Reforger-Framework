...
{	
	...
	override void PerformAction(IEntity pOwnerEntity, IEntity pUserEntity)
	{
		...
		COA_PlayerRplToAuthorityManager.GetInstance().StopRushPlantingSound();
		
		// Send plant command to authority (this will trigger bomb ticking sound)
		COA_PlayerRplToAuthorityManager.GetInstance().ToggleRushMCOMPlanted(mcomIdentifier, true);
	...
	override void OnActionStart(IEntity pUserEntity)
	{
		...
		COA_PlayerRplToAuthorityManager.GetInstance().StartRushPlantingSound();
	}
