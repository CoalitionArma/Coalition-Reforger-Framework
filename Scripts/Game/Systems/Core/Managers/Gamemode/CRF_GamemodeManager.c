...
//=============================================================================================================================================================================================================================================================================================================================================================
	...
	void InitilizePlayer(int playerId, vector spawnLocation[4])
	{
		...
		if (!m_SlottingManager.IsPlayerInASlot(playerId) || m_SlottingManager.IsPlayerConsideredDead(playerId))
		{
			...
			playerCharacter = CreateSpectatorEntity(playerController, CRF_EntityHelper.ZERO_SPAWN_VECTOR);
...
//=============================================================================================================================================================================================================================================================================================================================================================
	...
	//! \param[in] playerController The player controller to check for existing spectator
	//! \param[in] spawnLocation Location to spawn the spectator
	//! \return The created spectator character
	protected CRF_PlayerCharacter CreateSpectatorEntity(SCR_PlayerController playerController, vector spawnLocation[4])
	{
		...
		// Assign spectator to player immediately using direct assignment
		// Spectators don't need the full spawn pipeline
		if (spec)
