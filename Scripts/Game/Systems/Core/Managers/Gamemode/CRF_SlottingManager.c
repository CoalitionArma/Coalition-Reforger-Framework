...
//=============================================================================================================================================================================================================================================================================================================================================================
	...
	//------------------------------------------------------------------------------------------------
	//! Returns the sorted index of a slot within its group, or -1 when not found.
	int GetSlotIndexInGroup(int slotId)
	{
		CRF_SlotData slotData = GetSlotData(slotId);
		if (!slotData)
			return -1;
		
		array<int> slotIds = GetAllSlotIDsForGroup(slotData.GetSlotCurrentGroup());
