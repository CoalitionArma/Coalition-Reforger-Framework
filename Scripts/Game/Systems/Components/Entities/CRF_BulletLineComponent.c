...
//	{
//		if (!m_PlayerController.m_bIsBulletTrackingEnabled || !COA_EntityHelper.IsSpectator()(m_PlayerController.GetControlledEntity()))
//			return;
...
//			return;
//		
//		if (!SCR_PlayerController.Cast(GetGame().GetPlayerController()).m_bIsBulletTrackingEnabled || !COA_EntityHelper.IsSpectator()(SCR_PlayerController.GetLocalControlledEntity()))
//			return;
//		
//		Shape line;
//		if (m_iCurrentPoint + 1 > 2)
