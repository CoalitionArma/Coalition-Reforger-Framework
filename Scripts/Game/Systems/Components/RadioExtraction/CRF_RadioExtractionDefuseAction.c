...
class CRF_RadioExtractionDefuseAction : ScriptedUserAction
{
	...
	override void PerformAction(IEntity pOwnerEntity, IEntity pUserEntity)
	{
		...
		CRF_GameplayRplToAuthorityManager.GetInstance().RequestStopPositionalSound(m_RadioExtraction.m_sDefuseSoundEvent);
		CRF_GameplayRplToAuthorityManager.GetInstance().RequestRadioExtractionSetPlanted(false);
	...
	override void OnActionStart(IEntity pUserEntity)
	{
		...
		if (m_RadioExtraction && GetOwner())
			CRF_GameplayRplToAuthorityManager.GetInstance().RequestPlayPositionalSound(m_RadioExtraction.m_rDefuseSoundResource, m_RadioExtraction.m_sDefuseSoundEvent, GetOwner().GetOrigin());
	}
