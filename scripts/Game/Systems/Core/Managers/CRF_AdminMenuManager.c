...
class CRF_AdminMenuManager : ScriptComponent
{
	...
	*/
	...
	void UpdateGearSets(ResourceName bluGear, ResourceName opfGear, ResourceName indGear, ResourceName civGear)
	{		
		// Update the gearscript in the gamemode
		CRF_Gamemode.GetInstance().m_BLUFORGearScriptSettings.m_rGearScript = bluGear;
		CRF_Gamemode.GetInstance().m_OPFORGearScriptSettings.m_rGearScript = opfGear;
		CRF_Gamemode.GetInstance().m_INDFORGearScriptSettings.m_rGearScript = indGear;
		CRF_Gamemode.GetInstance().m_CIVILIANGearScriptSettings.m_rGearScript = civGear;
